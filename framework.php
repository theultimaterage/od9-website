...
.tier-flow .observer{background:color-mix(in srgb,var(--tier-observer) 20%,transparent);color:var(--tier-observer)}
.tier-flow .theorist{background:color-mix(in srgb,var(--tier-theorist) 20%,transparent);color:var(--tier-theorist)}
.tier-flow .architect{background:color-mix(in srgb,var(--tier-architect) 20%,transparent);color:var(--tier-architect)}
.tier-flow .pioneer{background:color-mix(in srgb,var(--tier-pioneer) 20%,transparent);color:var(--tier-pioneer)}
.tier-flow .benefactor{background:color-mix(in srgb,var(--tier-benefactor) 20%,transparent);color:var(--tier-benefactor)}
