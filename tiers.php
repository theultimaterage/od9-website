...
.tier-flow .arrow{color:#949494;font-size:1.1rem}
.tf-observer{background:color-mix(in srgb,var(--tier-observer) 20%,transparent);color:var(--tier-observer)}
.tf-theorist{background:color-mix(in srgb,var(--tier-theorist) 20%,transparent);color:var(--tier-theorist)}
.tf-architect{background:color-mix(in srgb,var(--tier-architect) 20%,transparent);color:var(--tier-architect)}
.tf-pioneer{background:color-mix(in srgb,var(--tier-pioneer) 20%,transparent);color:var(--tier-pioneer)}
.tf-benefactor{background:color-mix(in srgb,var(--tier-benefactor) 20%,transparent);color:var(--tier-benefactor)}
.tier-card{background:var(--carbon-dark);border-radius:12px;margin-bottom:2rem;border-left:4px solid;overflow:hidden}
.tier-card.observer{border-color:var(--tier-observer)}.tier-card.theorist{border-color:var(--tier-theorist)}.tier-card.architect{border-color:var(--tier-architect)}.tier-card.pioneer{border-color:var(--tier-pioneer)}.tier-card.benefactor{border-color:var(--tier-benefactor)}
...
.observer .tier-icon{background:color-mix(in srgb,var(--tier-observer) 15%,transparent);color:var(--tier-observer)}
.theorist .tier-icon{background:color-mix(in srgb,var(--tier-theorist) 15%,transparent);color:var(--tier-theorist)}
.architect .tier-icon{background:color-mix(in srgb,var(--tier-architect) 15%,transparent);color:var(--tier-architect)}
.pioneer .tier-icon{background:color-mix(in srgb,var(--tier-pioneer) 15%,transparent);color:var(--tier-pioneer)}
.benefactor .tier-icon{background:color-mix(in srgb,var(--tier-benefactor) 15%,transparent);color:var(--tier-benefactor)}
.tier-meta{flex:1}
...
.observer .tagline{color:var(--tier-observer)}.theorist .tagline{color:var(--tier-theorist)}.architect .tagline{color:var(--tier-architect)}.pioneer .tagline{color:var(--tier-pioneer)}.benefactor .tagline{color:var(--tier-benefactor)}
...
.observer .detail-box h4{color:var(--tier-observer)}.theorist .detail-box h4{color:var(--tier-theorist)}.architect .detail-box h4{color:var(--tier-architect)}.pioneer .detail-box h4{color:var(--tier-pioneer)}.benefactor .detail-box h4{color:var(--tier-benefactor)}
...
.r-adequate{border-color:#4169E1}.r-adequate .label{color:#6b8ff5}.r-adequate .pts{color:#6b8ff5}
.r-strong{border-color:#9932CC}.r-strong .label{color:#bb6be8}.r-strong .pts{color:#bb6be8}
