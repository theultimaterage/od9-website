...
<style>
body{background:var(--d);background-image:linear-gradient(45deg,#111 25%,transparent 25%),linear-gradient(-45deg,#111 25%,transparent 25%),linear-gradient(45deg,transparent 75%,#111 75%),linear-gradient(-45deg,transparent 75%,#111 75%);background-size:4px 4px;color:var(--c);font-family:'Exo 2',sans-serif;min-height:100vh}
...
<ul class="fund">
<li><strong>NCZ stream production</strong> - Show prep, recording, clips, overlays, thumbnails, and multi-platform distribution across YouTube and Twitch.</li>
...
<p style="text-align:center;margin-bottom:.6rem">No middleman. No platform cut. Scan and send directly — one-time, any amount.</p>
<p style="text-align:center;margin-bottom:1.5rem;color:#aaa">Every member's learning is AI-evaluated and members never pay for it — <strong style="color:#FFD700">$5 covers roughly 1,000 member evaluations.</strong> Your support literally funds someone else's climb. And every dollar is accounted for in public: <a href="funding.php" style="color:var(--b)">read the books &rarr;</a></p>
<div class="grid">
