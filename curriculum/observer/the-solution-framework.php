...
$lesson = [
  ...
  "canon" => [
    ...
    ["sec" => 2, "p" => "Consciousness-first design methodology represents our most fundamental departure from conventional system architecture. While traditional systems treat consciousness as epiphenomenal&mdash;a secondary product of physical processes&mdash;ASCEND recognizes what philosopher David Chalmers (1995) calls &ldquo;the hard problem of consciousness&rdquo;: the fact that subjective experience constitutes the foundation of all human values and meaning."],

    ["sec" => 3, "p" => "These systems fundamentally misalign individual advancement with collective flourishing, creating what game theorist Thomas Schelling (1978) called &ldquo;micromotives and macrobehavior&rdquo;&mdash;situations where individually rational choices produce collectively irrational outcomes. The ASCEND Achievement System fundamentally reimagines these structures to create what psychologist Mihaly Csikszentmihalyi (1990) terms &ldquo;autotelic activity&rdquo;&mdash;intrinsically meaningful action that simultaneously develops individual capability and contributes to collective advancement."],
