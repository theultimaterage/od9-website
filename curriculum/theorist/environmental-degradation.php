...
$lesson = [
  ...
  "canon" => [
    ...
    ["sec" => 2, "p" => "The carbon budget framework reveals the stark mathematical reality of climate constraints: either rapid systematic transformation of energy systems must occur, or temperature thresholds will be exceeded with consequences that persist for centuries to millennia."],

    ["sec" => 2, "p" => "Many tipping points become apparent only after they have been crossed, creating what Armstrong McKay et al. (2022) term an &ldquo;early warning gap.&rdquo; By the time empirical evidence conclusively demonstrates a tipping point has been crossed, intervention options have already diminished or disappeared."],

    ["sec" => 4, "p" => "The collective evidence indicates not merely incremental biodiversity loss but systematic collapse across multiple biological systems&mdash;a pattern consistent with previous mass extinction events in Earth&rsquo;s history but occurring at an unprecedented rate. As Ceballos et al. (2020) conclude: &ldquo;The ongoing sixth mass extinction may be the most serious environmental threat to the persistence of civilization, because it is irreversible.&rdquo;"],
