...
.album-cover{width:100%;border-radius:12px;box-shadow:0 0 30px rgba(255,68,68,0.3)}
...
/* Standard Release */
.release-section{background:var(--carbon-dark);border:1px solid #333;border-radius:16px;padding:2rem;margin-bottom:2rem}
.release-grid{display:grid;grid-template-columns:220px 1fr;gap:2rem;align-items:center}
.release-section .album-cover{box-shadow:var(--glow)}
